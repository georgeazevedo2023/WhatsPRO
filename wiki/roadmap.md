...
| **M18 Fluxos v3.0** | 🟡 S2 ✅ → S3 próximo | Unifica 17 módulos em experiência "Fluxos". 12 sprints (S1-S12). S1: DB+seed+types ✅ (e084c87). S2: Orchestrator Skeleton ✅ (367b4b0). Próximo: S3 Flow CRUD Admin UI. Sprints: [[wiki/fluxos-roadmap-sprints]] |
