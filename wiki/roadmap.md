...
| **M18 Fluxos v3.0** | 🟡 S11 ✅ → S12 próximo | Unifica 17 módulos em experiência "Fluxos". 12 sprints (S1-S12). S1-S11 ✅ (todos). S12 pendente: Métricas + E2E + Migração por instância. Próximo: S12. Sprints: [[wiki/fluxos-roadmap-sprints]] |
