...
| ~~P2~~ | ~~Wikis 2º nível AI Agent stale (5 arq)~~ | doc | — | — | ✅ **FEITO 06-20** — 5 wikis `ai-agent-*` reescritos (workflow ground-truth→rewrite→verify adversarial) refletindo router+5 specialists+qualificationGate+greetingPolicy+memória longa; validator-prompt agora "Sanitização determinística + TTS + Prompt Studio". Todos <300 lin, frontmatter 06-20, 0 wikilink quebrado. |
