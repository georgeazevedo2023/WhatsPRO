...
| **P3** | **Lint debt** (eslint informativo): 356 problemas (207 erros ~190 no-explicit-any + 149 warnings). **Fatia 06-19:** −26 imports não usados em 8 arq (unused-vars 107→81), tsc/build/vitest OK | code | large | `eslint .` | Continuar: unused-vars restantes (vars/consts c/ julgamento), no-explicit-any (tipar views SQL), exhaustive-deps (47). |
