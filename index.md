...
| [[log.md]] | **Sessão 2026-05-05** — D30 Fila Inteligente Sprint F (Helpdesk UI: hook useActiveQueueEvents + QueuePauseToggle + badge "Em fila" countdown + cancel queue em reassign). Smoke Playwright OK. Sprints D+F push pendentes; Portainer redeploya frontend após push. |
