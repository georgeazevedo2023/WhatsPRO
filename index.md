...
| [[wiki/migracao-eletropiso-COMPLETA]] | **🎉 MIGRAÇÃO LIVE 2026-05-06** — Eletropiso operando no novo `prfcbfumyrrycsrcrvms`. 1.944 rows + 4 storage migrados (diff=0). 41 edge fns + 15 crons + 8 secrets validados. Frontend cutover. n8n+UAZAPI atualizados. **4 hotfixes pós-cutover (R97/R98/R99/R101).** R101: GRANTs faltando para service_role quebravam TODAS as 41 edge fns silenciosamente — descoberto pelo smoke E2E real (curl no webhook). **Ref consolidada: endpoints, secrets, commits, pendências de rotação.** Frase retomada: "continuar smoke E2E migracao" |
