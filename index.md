...
| [[wiki/migracao-eletropiso-handoff]] | **HANDOFF ATIVO** — Migração Eletropiso pra Supabase novo (`prfcbfumyrrycsrcrvms`). MCP `supabase-novo` confirmado. Sprints 1-3 da auditoria SHIPPED (8/8 P1s). **Onda 0 da migração SHIPPED 2026-05-06** — inventário read-only completo em [[wiki/migracao-eletropiso-inventario]]. Próximo: Sprints 4-6 ou Onda 1 (replay schema). Frase retomada: "continuar migração eletropiso". |
