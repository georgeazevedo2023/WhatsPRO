...
| [[wiki/migracao-eletropiso-handoff]] | **HANDOFF ATIVO** — Migração Eletropiso pra Supabase novo (`prfcbfumyrrycsrcrvms`). Sprints 1-3 + Sprint 5 (parcial) shipped. **Onda 0 SHIPPED**, **Onda 1 SHIPPED 2026-05-06** (164 migrations / 91 tables / 224 policies). Próximo: Onda 2 (data migration ~1.900 rows + 7 auth users). |
