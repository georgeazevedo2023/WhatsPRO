...
| [[wiki/migracao-eletropiso-COMPLETA]] | **🎉 MIGRAÇÃO LIVE 2026-05-06** — Eletropiso operando no novo `prfcbfumyrrycsrcrvms`. 1.944 rows + 4 storage migrados (diff=0). 41 edge fns + 15 crons + 8 secrets validados. Frontend cutover. n8n+UAZAPI atualizados. **7 hotfixes pós-cutover (R97/R98/R99/R101/R102/R103/R104/R105/R106).** Smoke E2E completo. Projeto antigo `euljumeflwtljegknawy` PAUSADO 2026-05-06. **Ref consolidada: endpoints, secrets, commits, pendências de rotação.** Frase retomada: "executar A1 plano sandbox" |
...
| [[wiki/log-arquivo-2026-pre-05-08-part1]] · [[wiki/log-arquivo-2026-pre-05-08-part2]] · [[wiki/log-arquivo-2026-pre-05-08-part3]] · [[wiki/log-arquivo-2026-pre-05-08-part4]] · [[wiki/log-arquivo-2026-pre-05-08-part5]] · [[wiki/log-arquivo-2026-pre-05-08-part6]] · [[wiki/log-arquivo-2026-pre-05-08-part7]] | **Arquivo 2026-05-05 (tarde) → 2026-05-07** em 7 partes ≤300 linhas — Auditoria forense event-processor/process-jobs, R96-R114, Sandbox IA, Onda 2, Notif Handoff v7.32.0-2 (particionado em 2026-05-11) |
| `CHANGELOG.md` · [[wiki/changelog/2026-05-part1]] · [[wiki/changelog/2026-05-part2a]] · [[wiki/changelog/2026-05-part2b]] · [[wiki/changelog/2026-04-part1]] · [[wiki/changelog/2026-04-part2a]] · [[wiki/changelog/2026-04-part2b]] · [[wiki/changelog/2026-pre-04-part1]] · [[wiki/changelog/2026-pre-04-part2]] · [[wiki/changelog/2026-pre-04-part3a]] · [[wiki/changelog/2026-pre-04-part3b]] | **Changelog particionado** — `CHANGELOG.md` (raiz, releases ~14 dias) + arquivos por mês em `wiki/changelog/`. Substitui Changelog do PRD.md (particionado em 2026-05-11). |
| [[wiki/modulos]] · [[wiki/infraestrutura]] | Splits do PRD.md: tasks por módulo + stack/edge fns/storage. |
| [[wiki/roadmap/planejado-resumo]] · [[wiki/roadmap/m10-agente-ia-part1]] · [[wiki/roadmap/m11-ecommerce-part1]] · [[wiki/roadmap/m12-formularios]] · [[wiki/roadmap/m13-cursos-part1]] · [[wiki/roadmap/melhorias-existentes]] | Roadmap detalhado (split do PRD.md, M10-M13 + R18-R30). |
| [[wiki/erros/regras-preventivas]] · [[wiki/erros/historico-2026-05-part1]] · [[wiki/erros/historico-2026-05-part2]] | Splits do erros-e-licoes: tabela das ~30 regras + histórico R91-R114. |
| [[wiki/audio-pipeline]] | **Pipeline de áudio helpdesk (2026-05-10):** UAZAPI → webhook → Groq Whisper-large-v3 (primary) → Gemini 2.0-flash (fallback) → DB. Outgoing: ChatInput → bucket público → transcribe direto. Buckets, secrets, healthcheck SQL. |
