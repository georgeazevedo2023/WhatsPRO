/**
 * Tests for Playground v3 — media/audio scenarios, carousel, send_media,
 * audio steps, mixed interactions, and scenario template validation.
 */

/* ── Types (inline to avoid JSX import) ── */
...
interface ChatMessage { id: string; role: 'user' | 'assistant' | 'system'; content: string; timestamp: Date; tool_calls?: { name: string; args: Record<string, unknown> }[]; tokens?: { input: number; output: number }; latency_ms?: number; media_type?: string; }

/* ── computeResults replica ── */
