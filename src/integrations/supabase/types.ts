...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      bio_lead_captures: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bio_lead_captures_contact_id_fkey"
            columns: ["contact_id"]
            isOneToOne: false
      ...
      notification_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "notification_log_assigned_to_id_fkey"
          ...
          {
            foreignKeyName: "notification_log_instance_id_fkey"
            columns: ["instance_id"]
            isOneToOne: false
            referencedRelation: "instances"
            referencedColumns: ["id"]
      ...
      platform_usage_history: {
        Row: {
          active_crons: number
          alert_level: string
          db_bytes: number
          db_pct: number
          db_to_fn_calls_24h: number
          db_to_fn_error_pct_24h: number
          highest_dim: string
          highest_pct: number
          id: number
          mau: number
      ...
      user_profiles: {
        Row: {
          ...
          notifications_paused_by_user_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "user_profiles_notifications_paused_by_user_id_fkey"
            columns: ["notifications_paused_by_user_id"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      ...
      dash_sla_sem_resposta: {
        Args: { p_instance_id: string; p_threshold_in_minutes?: number }
        Returns: {
          contact_name: string
      ...
      get_previous_e2e_batch: {
        Args: { p_agent_id: string; p_exclude_batch_uuid: string }
        Returns: {
          batch_uuid: string
      ...
      set_contact_ia_blocked: {
        Args: { p_blocked: string[]; p_contact_id: string }
        Returns: undefined
      }
      set_my_queue_paused: {
      ...
      snapshot_platform_usage: { Args: never; Returns: Json }
      try_insert_greeting: {
        Args: {
          p_content: string
          p_conversation_id: string
