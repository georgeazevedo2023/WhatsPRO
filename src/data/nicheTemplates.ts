...
- Sugira produtos complementares quando relevante (ex: tinta + rolo + lixa)`,
  ...
  },
  {
    ...
    name: 'Concessionaria',
    icon: '\u{1F697}',
    description: 'Veiculos novos e seminovos, pecas, servicos',
    available: false,
    config: { greeting_message: '', personality: '', system_prompt: '', temperature: 0.7, handoff_triggers: [], handoff_max_conversation_minutes: 15, handoff_negative_sentiment: true, blocked_topics: [], blocked_phrases: [], extraction_fields: [], sub_agents: {}, context_long_enabled: true },
    suggested_labels: [],
  },
  {
    id: 'farmacia',
    name: 'Farmacia',
    icon: '\u{1F48A}',
    description: 'Medicamentos, cosmeticos, produtos de saude',
    available: false,
    config: { greeting_message: '', personality: '', system_prompt: '', temperature: 0.7, handoff_triggers: [], handoff_max_conversation_minutes: 15, handoff_negative_sentiment: true, blocked_topics: [], blocked_phrases: [], extraction_fields: [], sub_agents: {}, context_long_enabled: true },
    suggested_labels: [],
  },
  {
    ...
    name: 'Pet Shop',
    icon: '\u{1F43E}',
    description: 'Racoes, acessorios, banho e tosa, veterinario',
    available: false,
    config: { greeting_message: '', personality: '', system_prompt: '', temperature: 0.7, handoff_triggers: [], handoff_max_conversation_minutes: 15, handoff_negative_sentiment: true, blocked_topics: [], blocked_phrases: [], extraction_fields: [], sub_agents: {}, context_long_enabled: true },
    suggested_labels: [],
  },
